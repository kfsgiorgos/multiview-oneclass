...
if(arg5 == "yes"){
 ...
 print("1")
 GetCsvFromArff(datasetname = "Wilt_withoutdupl_norm_02_v01")
 print("2")
 GetCsvFromArff(datasetname = "Wilt_withoutdupl_norm_02_v03")
 print("3")
 GetCsvFromArff(datasetname = "Wilt_withoutdupl_norm_02_v04")
 print("4")
 GetCsvFromArff(datasetname = "Wilt_withoutdupl_norm_02_v06")
 print("5")
 GetCsvFromArff(datasetname = "Wilt_withoutdupl_norm_02_v07")
 print("6")
 GetCsvFromArff(datasetname = "Wilt_withoutdupl_norm_02_v09")
 print("7")
 GetCsvFromArff(datasetname = "Wilt_withoutdupl_norm_02_v10")
 print("8")
 GetTabularOutlierScore(datasetname = "Wilt_withoutdupl_norm_02_v01")
 print("9")
 GetTabularOutlierScore(datasetname = "Wilt_withoutdupl_norm_02_v03")
 print("10")
 GetTabularOutlierScore(datasetname = "Wilt_withoutdupl_norm_02_v04")
 print("11")
 GetTabularOutlierScore(datasetname = "Wilt_withoutdupl_norm_02_v06")
 print("12")
 GetTabularOutlierScore(datasetname = "Wilt_withoutdupl_norm_02_v07")
 print("13")
 GetTabularOutlierScore(datasetname = "Wilt_withoutdupl_norm_02_v09")
 print("14")
 GetTabularOutlierScore(datasetname = "Wilt_withoutdupl_norm_02_v10")

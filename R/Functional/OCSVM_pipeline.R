...
if(arg5 == "yes"){
 ...
 print("1")
 GetCsvFromArff(datasetname = "Parkinson_withoutdupl_norm_20_v01")
 print("2")
 GetCsvFromArff(datasetname = "Parkinson_withoutdupl_norm_20_v02")
 print("3")
 GetCsvFromArff(datasetname = "Hepatitis_withoutdupl_norm_10_v02")
 print("4")
 GetCsvFromArff(datasetname = "Hepatitis_withoutdupl_norm_10_v07")
 # print("5")
 # GetCsvFromArff(datasetname = "")
 # print("6")
 # GetCsvFromArff(datasetname = "")
 # print("7")
 # GetCsvFromArff(datasetname = "")
 print("8")
 GetTabularOutlierScore(datasetname = "Parkinson_withoutdupl_norm_20_v01")
 print("9")
 GetTabularOutlierScore(datasetname = "Parkinson_withoutdupl_norm_20_v02")
 print("10")
 GetTabularOutlierScore(datasetname = "Hepatitis_withoutdupl_norm_10_v02")
 print("11")
 GetTabularOutlierScore(datasetname = "Hepatitis_withoutdupl_norm_10_v07")
 # print("12")
 # GetTabularOutlierScore(datasetname = "")
 # print("13")
 # GetTabularOutlierScore(datasetname = "")
 # print("14")
 # GetTabularOutlierScore(datasetname = "")

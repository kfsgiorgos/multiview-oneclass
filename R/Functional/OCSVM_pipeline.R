...
if(arg5 == "yes"){
 ...
 print("8")
 GetCsvFromArff(datasetname = "PageBlocks_withoutdupl_norm_02_v01")
 print("9")
 GetCsvFromArff(datasetname = "PageBlocks_withoutdupl_norm_02_v03")
 print("10")
 GetCsvFromArff(datasetname = "PageBlocks_withoutdupl_norm_02_v04")
 print("11")
 GetCsvFromArff(datasetname = "PageBlocks_withoutdupl_norm_02_v06")
 print("12")
 GetCsvFromArff(datasetname = "PageBlocks_withoutdupl_norm_02_v07")
 print("13")
 GetCsvFromArff(datasetname = "PageBlocks_withoutdupl_norm_02_v08")
 print("14")
 GetCsvFromArff(datasetname = "PageBlocks_withoutdupl_norm_02_v09")


 print("15")
 GetTabularOutlierScore(datasetname = "Stamps_withoutdupl_norm_05_v01")
 print("16")
 GetTabularOutlierScore(datasetname = "Stamps_withoutdupl_norm_05_v02")
 print("17")
 GetTabularOutlierScore(datasetname = "Stamps_withoutdupl_norm_05_v03")
 print("18")
 GetTabularOutlierScore(datasetname = "Stamps_withoutdupl_norm_05_v05")
 print("19")
 GetTabularOutlierScore(datasetname = "Stamps_withoutdupl_norm_05_v06")
 print("20")
 GetTabularOutlierScore(datasetname = "Stamps_withoutdupl_norm_05_v07")
 print("21")
 GetTabularOutlierScore(datasetname = "Stamps_withoutdupl_norm_05_v08")
 print("22")
 GetTabularOutlierScore(datasetname = "Stamps_withoutdupl_norm_05_v09")
 print("23")
 GetTabularOutlierScore(datasetname = "Stamps_withoutdupl_norm_05_v10")


# print("92871)
 GetCsvFromArff(datasetname = "Stamps_withoutdupl_norm_05_v01")
 print("24")
 GetCsvFromArff(datasetname = "Stamps_withoutdupl_norm_05_v02")
 print("25")
 GetCsvFromArff(datasetname = "Stamps_withoutdupl_norm_05_v03")
 print("26")
 GetCsvFromArff(datasetname = "Stamps_withoutdupl_norm_05_v05")
 print("27")
 GetCsvFromArff(datasetname = "Stamps_withoutdupl_norm_05_v06")
 print("28")
 GetCsvFromArff(datasetname = "Stamps_withoutdupl_norm_05_v07")
 print("29")
 GetCsvFromArff(datasetname = "Stamps_withoutdupl_norm_05_v08")
 print("30")
 GetCsvFromArff(datasetname = "Stamps_withoutdupl_norm_05_v09")
 print("31")
 GetCsvFromArff(datasetname = "Stamps_withoutdupl_norm_05_v10")
 print("32")
 GetTabularOutlierScore(datasetname = "Pima_withoutdupl_norm_02_v01")
 print("33")
 GetTabularOutlierScore(datasetname = "Pima_withoutdupl_norm_02_v02")
 print("34")
 GetTabularOutlierScore(datasetname = "Pima_withoutdupl_norm_02_v03")

...
get_CV_experiments_paper_31_MUR_ensemble <- function(datasetname, experiments = "OC_combined_CV", CViterations, print_k, total_k) {
  ...
  randomOD_31_train <- get_train_representations(representationDT = list_one_randomOD[[31]])
  ...
  randomOD_31_test <- get_testCV_representations(representationDT = list_one_randomOD[[31]])
  ...
  representation31 <- rbindlist(get_scores_CV_per_randomOD(randomOD_train = randomOD_31_train, randomOD_test = randomOD_31_test, feature_col = "Representation_31"))
...
get_CV_experiments_paper_ensemble_iForest<- function(datasetname, experiments = "OC_combined_CV", CViterations) {
...
get_CV_experiments_paper_5_MUR_iForest_ensemble <- function(datasetname, experiments = "OC_combined_CV", CViterations) {
...
get_CV_experiments_paper_10_MUR_iForest_ensemble <- function(datasetname, experiments = "OC_combined_CV", CViterations) {
...
get_CV_experiments_paper_15_MUR_iForest_ensemble <- function(datasetname, experiments = "OC_combined_CV", CViterations) {

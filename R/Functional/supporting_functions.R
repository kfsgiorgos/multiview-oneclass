# Augmented space Ensemble - OCSVM ------------------------------------------------

# the following augmneted functions habe a coarse grid serach space
get_OCSVM_augmented_ensemble_30MUR <- function(datasetname, experiments = "OC_combined_CV", CViterations, print_k, total_k) {
  ...
  randomOD_22_train <- get_train_representations(representationDT = list_combined[[22]])
  randomOD_23_train <- get_train_representations(representationDT = list_combined[[23]])
  randomOD_24_train <- get_train_representations(representationDT = list_combined[[24]])
  randomOD_25_train <- get_train_representations(representationDT = list_combined[[25]])
  randomOD_26_train <- get_train_representations(representationDT = list_combined[[26]])
  randomOD_27_train <- get_train_representations(representationDT = list_combined[[27]])
  randomOD_28_train <- get_train_representations(representationDT = list_combined[[28]])
  randomOD_29_train <- get_train_representations(representationDT = list_combined[[29]])
  randomOD_30_train <- get_train_representations(representationDT = list_combined[[30]])
  ...
  randomOD_22_test <- get_testCV_representations(representationDT = list_combined[[22]])
  randomOD_23_test <- get_testCV_representations(representationDT = list_combined[[23]])
  randomOD_24_test <- get_testCV_representations(representationDT = list_combined[[24]])
  randomOD_25_test <- get_testCV_representations(representationDT = list_combined[[25]])
  randomOD_26_test <- get_testCV_representations(representationDT = list_combined[[26]])
  randomOD_27_test <- get_testCV_representations(representationDT = list_combined[[27]])
  randomOD_28_test <- get_testCV_representations(representationDT = list_combined[[28]])
  randomOD_29_test <- get_testCV_representations(representationDT = list_combined[[29]])
  randomOD_30_test <- get_testCV_representations(representationDT = list_combined[[30]])
  ...
  get_scores_CV_per_randomOD <- function(randomOD_train, randomOD_test, feature_col) {
    ...
    for(ij in 1:10){
      ...
      for(kernels in c("linear", "rbf", "sigmoid")){
        for(nus in c(0.5)){
          for(gammas in c(1/dim(CVtrain_DT)[2])){
            iters <- iters+1
  ...
  representation22 <- rbindlist(get_scores_CV_per_randomOD(randomOD_train = randomOD_22_train, randomOD_test = randomOD_22_test, feature_col = "Representation_22"))
  representation23 <- rbindlist(get_scores_CV_per_randomOD(randomOD_train = randomOD_23_train, randomOD_test = randomOD_23_test, feature_col = "Representation_23"))
  representation24 <- rbindlist(get_scores_CV_per_randomOD(randomOD_train = randomOD_24_train, randomOD_test = randomOD_24_test, feature_col = "Representation_24"))
  representation25 <- rbindlist(get_scores_CV_per_randomOD(randomOD_train = randomOD_25_train, randomOD_test = randomOD_25_test, feature_col = "Representation_25"))
  representation26 <- rbindlist(get_scores_CV_per_randomOD(randomOD_train = randomOD_26_train, randomOD_test = randomOD_26_test, feature_col = "Representation_26"))
  representation27 <- rbindlist(get_scores_CV_per_randomOD(randomOD_train = randomOD_27_train, randomOD_test = randomOD_27_test, feature_col = "Representation_27"))
  representation28 <- rbindlist(get_scores_CV_per_randomOD(randomOD_train = randomOD_28_train, randomOD_test = randomOD_28_test, feature_col = "Representation_28"))
  representation29 <- rbindlist(get_scores_CV_per_randomOD(randomOD_train = randomOD_29_train, randomOD_test = randomOD_29_test, feature_col = "Representation_29"))
  representation30 <- rbindlist(get_scores_CV_per_randomOD(randomOD_train = randomOD_30_train, randomOD_test = randomOD_30_test, feature_col = "Representation_30"))
  ...
  representationsDT <- rbindlist(list(representation1, representation2, 
                                      ...
                                      representation21, representation22,
                                      representation23, representation24,
                                      representation25, representation26,
                                      representation27, representation28,
                                      representation29, representation30
...
get_OCSVM_augmented_ensemble_25MUR <- function(datasetname, experiments = "OC_combined_CV", CViterations, print_k, total_k) {
...
get_OCSVM_augmented_ensemble_20MUR <- function(datasetname, experiments = "OC_combined_CV", CViterations, print_k, total_k) {
...
# Unsupervised space Ensemble - OCSVM ------------------------------------------------


get_OCSVM_ensemble_30MUR <- function(datasetname, experiments = "OC_combined_CV", CViterations, print_k, total_k) {
  ...
  randomOD_22_train <- get_train_representations(representationDT = list_one_randomOD[[22]])
  randomOD_23_train <- get_train_representations(representationDT = list_one_randomOD[[23]])
  randomOD_24_train <- get_train_representations(representationDT = list_one_randomOD[[24]])
  randomOD_25_train <- get_train_representations(representationDT = list_one_randomOD[[25]])
  randomOD_26_train <- get_train_representations(representationDT = list_one_randomOD[[26]])
  randomOD_27_train <- get_train_representations(representationDT = list_one_randomOD[[27]])
  randomOD_28_train <- get_train_representations(representationDT = list_one_randomOD[[28]])
  randomOD_29_train <- get_train_representations(representationDT = list_one_randomOD[[29]])
  randomOD_30_train <- get_train_representations(representationDT = list_one_randomOD[[30]])
  ...
  randomOD_22_test <- get_testCV_representations(representationDT = list_one_randomOD[[22]])
  randomOD_23_test <- get_testCV_representations(representationDT = list_one_randomOD[[23]])
  randomOD_24_test <- get_testCV_representations(representationDT = list_one_randomOD[[24]])
  randomOD_25_test <- get_testCV_representations(representationDT = list_one_randomOD[[25]])
  randomOD_26_test <- get_testCV_representations(representationDT = list_one_randomOD[[26]])
  randomOD_27_test <- get_testCV_representations(representationDT = list_one_randomOD[[27]])
  randomOD_28_test <- get_testCV_representations(representationDT = list_one_randomOD[[28]])
  randomOD_29_test <- get_testCV_representations(representationDT = list_one_randomOD[[29]])
  randomOD_30_test <- get_testCV_representations(representationDT = list_one_randomOD[[30]])
...
get_OCSVM_ensemble_25MUR <- function(datasetname, experiments = "OC_combined_CV", CViterations, print_k, total_k) {
...
get_OCSVM_ensemble_20MUR <- function(datasetname, experiments = "OC_combined_CV", CViterations, print_k, total_k) {
...
get_OCSVM_ensemble_15MUR <- function(datasetname, experiments = "OC_combined_CV", CViterations, print_k, total_k) {
...
get_OCSVM_ensemble_10MUR <- function(datasetname, experiments = "OC_combined_CV", CViterations, print_k, total_k) {
...
get_OCSVM_ensemble_5MUR <- function(datasetname, experiments = "OC_combined_CV", CViterations, print_k, total_k) {

...
for( k in 1:as.numeric(arg3)){
  print(Sys.time())
  list_res_1[[k]] <- get_CV_experiments_paper_25MUR_ensemble(datasetname = arg1, 
                                                             experiments = "OC_combined_CV", 
...
get_evaluation_26MUR <- function(list_results) {
...
MUR_26 <- get_evaluation_26MUR(list_results = list_res_1)
...
fwrite(MUR_26, paste0(final_path_to_save, "figures/",
                       arg2, "/", arg1, "_OCSVM_Multiple_Repres_26_allMetrics", arg3,"_iters.csv"))

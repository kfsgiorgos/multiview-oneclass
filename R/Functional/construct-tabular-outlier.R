...
#GetTabularOutlierScore(datasetname = "Stamps_withoutdupl_norm_05_v04.results")
...
# GetTabularOutlierScore(datasetname = "WBC_withoutdupl_norm_v01.results")
# system.time({GetTabularOutlierScore(datasetname = "WPBC_withoutdupl_norm.results")})
...
# system.time({GetTabularOutlierScore(datasetname = "Parkinson_withoutdupl_norm_05_v01.results")})
# system.time({GetTabularOutlierScore(datasetname = "Lymphography_withoutdupl_catremoved.results")})
...
# GetCsvFromArff(datasetname = "Parkinson_withoutdupl_norm_05_v07")
...
# GetCsvFromArff(datasetname = "Stamps_withoutdupl_norm_05_v04")
...
system.time({GetCsvFromArff(datasetname = "Lymphography_withoutdupl_norm_catremoved")})
# print(Sys.time())
# system.time({GetCsvFromArff(datasetname = "WPBC_withoutdupl_norm")})
